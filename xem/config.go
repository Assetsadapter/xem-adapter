...
func (this *WalletManager) LoadAssetsConfig(c config.Configer) error {
	...
	//	this.ChainId = 12
	//this.Config.EthereumKeyPath = c.String("EthereumKeyPath") //"/Users/peter/workspace/bitcoin/wallet/src/github.com/xem/go-xem/chain/keystore"
	//每次都向节点查询nonce
...
func (this *WalletConfig) LoadConfig(configFilePath string, configFileName string) (*WalletConfig, error) {
	...
	//	this.ChainId = 12
	this.EthereumKeyPath = c.String("EthereumKeyPath") //"/Users/peter/workspace/bitcoin/wallet/src/github.com/xem/go-xem/chain/keystore"
	//每次都向节点查询nonce
	localnonce, err := c.Bool("LocalNonce")
	if err != nil {
		log.Error("LocalNonce error, err=", err)
...
//	c.EthereumKeyPath = "/Users/peter/workspace/bitcoin/wallet/src/github.com/xem/go-xem/chain/keystore"
//	c.ChainID = 12
//	this.Config = &c
//	//创建目录
//	file.MkdirAll(c.DbPath)
